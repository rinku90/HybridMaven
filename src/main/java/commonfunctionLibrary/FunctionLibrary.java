	 ...
	 static WebDriver driver;
		...
		public static WebDriver startBrowser() throws Exception{
			...
			if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")){
				System.setProperty("webdriver.chrome.driver", "D:\\Srikant_82\\StockAccounting_Hybrid\\driver\\chromedriver.exe");
		...
		public static void tableValidation(WebDriver driver,String column) throws Exception{
			...
			FileReader fr = new FileReader("D:\\Srikant_82\\StockAccounting_Hybrid\\CaptureData\\suppnumber.txt");
		...
		public static void captureData(WebDriver driver,String locatortytpe,
			...
			FileWriter fw=new FileWriter ("D:\\Srikant_82\\StockAccounting_Hybrid\\CaptureData\\suppnumber.txt");
