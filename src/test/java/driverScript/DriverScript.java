...
public static WebDriver driver;
	public static void main(String[] args) throws Exception {
        ...
        report = new ExtentReports("D:\\Srikant_82\\StockAccounting_Hybrid_maven82\\Reports\\"+TCModule+FunctionLibrary.generateDate()+".html");
	...
	}catch(Exception e)
	{
		...
		FileUtils.copyFile(srcFile, new File("D:\\Srikant_82\\StockAccounting_Hybrid_maven82\\Screenshots\\"+Description+FunctionLibrary.generateDate()+".png"));
		test.log(LogStatus.INFO, Description);
		test.log(LogStatus.INFO,test.addScreenCapture("D:\\Srikant_82\\StockAccounting_Hybrid_maven82\\Screenshots\\"+Description+FunctionLibrary.generateDate()+"png"));
		break;
	}		
}
